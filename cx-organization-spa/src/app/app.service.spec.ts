...
describe('AppService', () => {
  ...
  describe('setPositionForNewNotification', () => {
    ...
    it('should append to the head of array', () => {
      ...
      expect(newNotificationItemId).toEqual(
        mockDescSortedByDateCurrentNotificationItems[0].id
      );
    });
    ...
    it('should append to the second position in the array (index = 1)', () => {
      ...
      expect(newNotificationItemId).toEqual(
        mockDescSortedByDateCurrentNotificationItems[1].id
      );
    });
    ...
    it('should append to the end of the array', () => {
      ...
      expect(newNotificationItemId).toEqual(
        mockDescSortedByDateCurrentNotificationItems[
          mockDescSortedByDateCurrentNotificationItems.length - 1
        ].id
      );
    });
    ...
    it('should not add new notification to the list (because of duplication)', () => {
      ...
      expect(mockDescSortedByDateCurrentNotificationItems.length).toEqual(
        mockDescSortedByDateCurrentNotificationItemsInitalLength
      );
    });
  });
});
