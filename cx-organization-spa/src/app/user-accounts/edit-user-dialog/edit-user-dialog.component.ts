...
export class EditUserDialogComponent
  ...
  disableCurrentApprovalInfo: boolean = false;
  ...
  private initHelper(): void {
    ...
    this.disableCurrentApprovalInfo =
      this.mode === EditUserDialogModeEnum.Edit
        ? this.isCheckCurrentUserStatus()
        : false;
  ...
  private isCheckCurrentUserStatus(): boolean {
    if (
      this.user.entityStatus.statusId === StatusTypeEnum.Archived.code ||
      this.user.entityStatus.statusId === StatusTypeEnum.Suspended.code ||
      this.user.entityStatus.statusId === StatusTypeEnum.Rejected.code ||
      this.user.entityStatus.statusId === StatusTypeEnum.Inactive.code ||
      this.user.entityStatus.statusId ===
