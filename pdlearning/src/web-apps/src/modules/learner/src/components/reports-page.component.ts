...
import { IOpalReportDynamicParams, LearnerRoutePaths, OpalReportDynamicComponent } from '@opal20/domain-components';
...
export class ReportsPageComponent extends BasePageComponent {
  ...
  public ngOnInit(): void {
    this.paramsReportDynamic = OpalReportDynamicComponent.buildLearnerReportList();
    this.updateDeeplink(`learner/${LearnerRoutePaths.ReportsPage}`);
  }
}
