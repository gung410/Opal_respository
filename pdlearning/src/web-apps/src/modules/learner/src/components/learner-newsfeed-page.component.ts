...
const pageSize = 10;
@Component({
  selector: 'learner-newsfeed-page',
  templateUrl: './learner-newsfeed-page.component.html'
})
export class LearnerNewsFeedPageComponent extends BaseComponent implements OnInit {
  @Output()
  public newsFeedClick: EventEmitter<Newsfeed> = new EventEmitter<Newsfeed>();
  @Output()
  public newsFeedBackClick: EventEmitter<void> = new EventEmitter<void>();
