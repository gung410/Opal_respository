...
@Component({
  selector: 'question-text-option-editor',
  templateUrl: './question-text-option-editor.component.html'
})
export class QuestionTextOptionEditorComponent extends BaseFormComponent {
  ...
  // We need to confirm with B.A about validation on each text option.
  // The code block below is validating content of text option
