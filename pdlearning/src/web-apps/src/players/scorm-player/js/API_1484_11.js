...
SCORM_1_3.ActivityTreeNode.prototype = {
  ...
  getDataTreeValue: function(dataElement) {
        ...
        if (this.getDataTreeValue('cmi.credit') === 'credit') {
          if (this.getDataTreeValue('cmi.completion_threshold') != null) {
            if (this.getDataTreeValue('cmi.progress_measure') != null) {
              window.postMessage(
                JSON.stringify({
                  key: 'FinishedToTheEnd'
                }),
                '*'
              );
              if (
                parseFloat(this.getDataTreeValue('cmi.progress_measure')) >= parseFloat(this.getDataTreeValue('cmi.completion_threshold'))
              ) {
                return 'completed';
              } else {
                return 'incomplete';
    ...
    if (dataElement === 'cmi.completion_status' && $0['value'] === 'completed') {
      window.postMessage(
        JSON.stringify({
          key: 'FinishedToTheEnd',
          completion_status: this.$F['cmi.completion_status'].value === 'completed',
          success_status: this.$F['cmi.success_status'].value === 'passed'
        }),
        '*'
      );
    }
...
SCORM_1_3.ActivityTree.prototype = {
  ...
  requestNavigation: function(navigationRequest) {
    if (!this.$24 && this.getActiveAPI() != null && this.getActiveAPI().isInitAttempted() && !this.getActiveAPI().isFinishAttempted()) {
      this.getActiveAPI()
        .getActivityTreeNode()
        .setDataTreeValue('adl.nav.request', navigationRequest, false);
  ...
  $50: function() {
    ...
    if (this.get_$2B() === this.get_$37()) {
      ...
      if ($F != null) {
        ...
        var $14 = this.get_$3B();
        if (
          (!$14.getParentSequencing().flow || !this.get_$37().getParentSequencing().flow) &&
          this.get_$37() !== $14 &&
          this.get_$37() !== $F
        ) {
          this.set_$2D(null);
      ...
      if (
        ($11 !== this.get_$37() && $11 !== this.get_$37().getParent()) ||
        ($11 === this.get_$37().getParent() && $11 !== this.get_$2B())
      ) {
  ...
  $56: function() {
    var $0 = this.get_$2B()
      .getParent()
      .getPath(this.getOrganization(), true, true, true);
    var $1 = null;
    var $enum1 = $0.getEnumerator();
    while ($enum1.moveNext()) {
  ...
  $58: function($p0, $p1) {
    ...
    for (var $key2 in $dict1) {
      ...
      if ($6 === 'attemptLimitExceeded') {
        $4 =
          $9.activityProgressStatus &&
          $p1.getSequencing().limitConditions_attemptControl &&
          $9.attemptCount >= parseInt($p1.getSequencing().limitConditions_attemptLimit)
            ? 'true'
            : 'false';
        if (!$9.activityProgressStatus) {
          $4 = 'unknown';
  ...
  $5E: function($p0) {
    this.$5F($p0);
    if (
      !$p0.getSequencing().getPrimaryObjective().satisfiedByMeasure &&
  ...
  $60: function($p0) {
    if (
      $p0.getSequencing().getConditionRollupRulesForAction('notSatisfied').length === 0 &&
      $p0.getSequencing().getConditionRollupRulesForAction('satisfied').length === 0
    ) {
      var $2 = {};
  ...
  $62: function($p0, $p1) {
    ...
    if ($p1 === 'satisfied' || $p1 === 'notSatisfied') {
      if ($p0.getSequencing().rollupObjectiveSatisfied) {
        $1 = true;
        if (
          ($p1 === 'satisfied' && $p0.getSequencing().rollupConsiderations_requiredForSatisfied === 'ifNotSuspended') ||
          ...
          if (
            ($p1 === 'satisfied' && $p0.getSequencing().rollupConsiderations_requiredForSatisfied === 'ifAttempted') ||
            ...
            if (
              ($p1 === 'satisfied' && $p0.getSequencing().rollupConsiderations_requiredForSatisfied === 'ifNotSkipped') ||
              ($p1 === 'notSatisfied' && $p0.getSequencing().rollupConsiderations_requiredForNotSatisfied === 'ifNotSkipped')
            ) {
    ...
    if ($p1 === 'completed' || $p1 === 'incomplete') {
      if ($p0.getSequencing().rollupProgressCompletion) {
        $1 = true;
        if (
          ($p1 === 'completed' && $p0.getSequencing().rollupConsiderations_requiredForCompleted === 'ifNotSuspended') ||
          ...
          if (
            ($p1 === 'completed' && $p0.getSequencing().rollupConsiderations_requiredForCompleted === 'ifAttempted') ||
            ...
            if (
              ($p1 === 'completed' && $p0.getSequencing().rollupConsiderations_requiredForCompleted === 'ifNotSkipped') ||
  ...
  $63: function($p0, $p1) {
    ...
    for (var $key2 in $dict1) {
      ...
      if ($6 === 'attemptLimitExceeded') {
        $4 =
          $5.activityProgressStatus &&
          $p0.getSequencing().limitConditions_attemptControl &&
          $5.attemptCount >= parseInt($p0.getSequencing().limitConditions_attemptLimit)
            ? 'true'
            : 'false';
        if (!$5.activityProgressStatus) {
          $4 = 'unknown';
  ...
  $66: function($p0) {
    if (
      $p0.getSequencing().getConditionRollupRulesForAction('incomplete').length === 0 &&
      $p0.getSequencing().getConditionRollupRulesForAction('completed').length === 0
    ) {
      var $1 = {};
  ...
  $68: function() {
    ...
    if (!this.get_$2D().getSequencing().tracked) {
      this.get_$2D()
        .getSequencing()
        .status.set_attemptProgressStatus(false);
      this.get_$2D()
        .getSequencing()
        .status.set_objectiveProgressStatus(false);
    }
    this.set_$45(null);
    if (!this.$24) {
  ...
  $6F: function($p0) {
    ...
    if ($p0.getSequencing().limitConditions_attemptControl) {
      if (
        $p0.getSequencing().status.activityProgressStatus &&
        $p0.getSequencing().status.attemptCount >= parseInt($p0.getSequencing().limitConditions_attemptLimit)
      ) {
        $0 = true;
        return $0;
      }
  ...
  $70: function() {
    ...
    $0.sort(
      Delegate.create(this, function($p1_0, $p1_1) {
        var $1_0 = $p1_0;
        var $1_1 = $p1_1;
  ...
  $73: function($p0, $p1, $p2, $p3, $p4, $p5) {
    ...
    if (!$p5) {
      ...
      $3 =
        API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'isvisible') == null ||
        API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'isvisible') === 'true';
    } else {
      this.$1E =
        API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'sharedDataGlobalToSystem') == null ||
        API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'sharedDataGlobalToSystem') === 'true';
      this.$1F =
        API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'objectivesGlobalToSystem') == null ||
        API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'objectivesGlobalToSystem') === 'true';
      if (!this.$1F) {
        if (this.$1D == null) {
          this.$20 = {};
        }
    ...
    for (var $A = 0; $A < $p1.childNodes.length; $A++) {
      ...
      if ($B === 'title') {
        ...
        $5.setCompletedbymeasure(
          API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$A], 'completedByMeasure') != null &&
            API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$A], 'completedByMeasure') === 'true'
        );
        ...
        if (!isNullOrUndefined($14)) {
          ...
          for (var $16 = 0; $16 < $14.childNodes.length; $16++) {
            ...
            var $19 = API_BASE.BaseUtils.getText($17)
              .trim()
              .toLowerCase();
            if (!$15.contains($19)) {
              $15.add($19);
  ...
  $74: function($p0, $p1, $p2) {
    ...
    for (var $9 = 0; $9 < $p1.childNodes.length; $9++) {
      ...
      if ($A === 'controlmode') {
        ...
        $p0.getSequencing().manifestCompletionSetByContent =
          API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'completionSetByContent') === 'true';
        $p0.getSequencing().manifestObjectiveSetByContent =
          API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'objectiveSetByContent') === 'true';
        ...
        $p0.getSequencing().limitConditions_attemptAbsoluteDurationLimit = API_BASE.BaseUtils.getXMLNodeAttribut(
          $p1.childNodes[$9],
        ...
        $p0.getSequencing().constrainedChoiceConsiderations_preventActivation =
          API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'preventActivation') === 'true';
        $p0.getSequencing().constrainedChoiceConsiderations_constrainChoice =
          API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'constrainChoice') === 'true';
    ...
    for (var $key2 in $dict1) {
      ...
      while ($enum3.moveNext()) {
        ...
        this.$0
          .getSequencing()
          .getActivityTreeNode()
          .getRoot().isGlobalObjectivesUpdateAvailable = false;
        try {
          var $10 = false;
          ...
          this.$0
            .getSequencing()
            .getActivityTreeNode()
            .getRoot().isGlobalObjectivesUpdateAvailable = $F;
        }
      }
    }
  }
...
SCORM_1_3.API_1484_11_LIB = function(activityTreeNode) {
  ...
  this.$17 =
    '^previous$|^continue$|^exit$|^exitAll$|^abandon$|^abandonAll$|^suspendAll$|^{target=' +
  ...
  this.$2A['cmi.max_time_allowed'] = {
    defaultvalue:
      activityTreeNode.getSequencing() != null ? activityTreeNode.getSequencing().limitConditions_attemptAbsoluteDurationLimit : null,
    mod: 'r'
  };
  this.$2A['cmi.mode'] = {
    defaultvalue: 'normal',
  ...
  this.$2A['cmi.scaled_passing_score'] = {
    defaultvalue:
      activityTreeNode.getSequencing() != null &&
      activityTreeNode.getSequencing().getPrimaryObjective() != null &&
      activityTreeNode.getSequencing().getPrimaryObjective().satisfiedByMeasure
        ? activityTreeNode.getSequencing().getPrimaryObjective().minNormalizedMeasure
        : null,
    format: this.$C,
    range: this.$23,
    mod: 'r'
      ...
      for (var $7 = 0; $7 < this.$2C.getSequencing().getObjectivesCount(); $7++) {
        ...
        if ($9.get_objectiveProgressStatus()) {
          this.$2C.setDataTreeValue(
            'cmi.objectives.' + $7 + '.success_status',
            $9.get_objectiveSatisfiedStatus() ? 'passed' : 'failed',
            false
          );
        }
        if ($9.get_objectiveMeasureStatus()) {
        ...
        if ($9.get_attemptProgressStatus()) {
          this.$2C.setDataTreeValue(
            'cmi.objectives.' + $7 + '.completion_status',
            $9.get_attemptCompletionStatus() ? 'completed' : 'incomplete',
            false
          );
        }
  ...
  Terminate: function(param) {
    ...
    if (param === '') {
      if (this.$2D && !this.$2E) {
        ...
        this.$2C.setDataTreeValue(
          'cmi.total_time',
          SCORM_1_3.Utils.addTime(this.$2C.getDataTreeValue('cmi.total_time'), this.$2C.getDataTreeValue('cmi.session_time')),
          false
        );
              ...
              if ($6 != null && ($6.join('').length > 0 || value.length === 0)) {
                if ($2 === this.$7 || $2 === this.$6) {
                  ...
                  if (
                    ...
                    $6[1] !== 'x' &&
                    $6[1] !== 'i' &&
                    isUndefined(this.$0[$6[1].toLowerCase()])
                  ) {
                    this.$30 = '406';
                  }
                } else if ($2 === this.$8) {
                          ...
                          if (!isUndefined(this.$2C.getDataTreeValue($9 + '._count'))) {
                            if (!this.$34(element, $9, value)) {
                              if ($7[$7.length - 2] === this.$2C.getDataTreeValue($9 + '._count')) {
                                this.$2C.setDataTreeValue(
                                  $9 + '._count',
                                  (parseInt(this.$2C.getDataTreeValue($9 + '._count')) + 1).toString(),
                                  false
                                );
                              }
                            } else {
                        ...
                        case 'cmi.interactions.n.correct_responses.n.pattern':
                          if (!isUndefined(this.$2C.getDataTreeValue($9 + '._count'))) {
                            if ($7[$7.length - 2] === this.$2C.getDataTreeValue($9 + '._count')) {
                              ...
                              if (
                                isUndefined(this.$29[$E]['limit']) ||
                                parseInt(this.$2C.getDataTreeValue($9 + '._count')) < parseInt(this.$29[$E]['limit'])
                              ) {
                                this.$30 = this.$36(element, $E, value, this.$29[$E]);
                                if (
                                  (this.$30 === '0' && (!this.$29[$E]['duplicate'] || !this.$35(element, $9, value))) ||
                                  (this.$30 === '0' && value === '')
                                ) {
                                  this.$2C.setDataTreeValue(
                                    $9 + '._count',
                      ...
                      switch ($1) {
                        ...
                        case 'cmi.interactions.n.correct_responses.n.pattern':
                          ...
                          if (isNullOrUndefined(this.$2C.getDataTreeValue($11 + '.type'))) {
                            ...
                            if (
                              isUndefined(this.$29[$12]['limit']) ||
                              parseInt(this.$2C.getDataTreeValue($9 + '._count')) <= parseInt(this.$29[$12]['limit'])
                            ) {
      ...
      for (var $key2 in $dict1) {
        ...
        if ($0.key.startsWith($p0 + '.n.')) {
          if (!isUndefined(Type.safeCast($0.value, Object)['defaultvalue'])) {
            this.$2C.setDataTreeValue(
              $p0 + '.' + $p1 + $0.key.substr(($p0 + '.n.').length - 1),
