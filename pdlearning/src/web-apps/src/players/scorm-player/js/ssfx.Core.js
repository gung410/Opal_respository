...
ScriptFX.CollectionChangedAction.prototype = { add: 0, remove: 1, reset: 2 };
...
ScriptFX.HostName.prototype = { other: 0, IE: 1, mozilla: 2, safari: 3, opera: 4 };
...
ScriptFX.Net.HTTPRequestState.prototype = { inactive: 0, inProgress: 1, completed: 2, aborted: 3, timedOut: 4 };
ScriptFX.Net.HTTPRequestState.createEnum('ScriptFX.Net.HTTPRequestState', false);
ScriptFX.Net.HTTPVerb = function() {};
ScriptFX.Net.HTTPVerb.prototype = { GET: 0, POST: 1, PUT: 2, DELETE: 3 };
...
ScriptFX.UI.AnimationStopState.prototype = { complete: 0, abort: 1, revert: 2 };
...
ScriptFX.UI.DragMode.prototype = { move: 0, copy: 1 };
...
ScriptFX.UI.AnimationManager.$3 = function() {
  ...
  if ($2.length !== 0) {
    ...
    if (ScriptFX.UI.AnimationManager.$2 === 0) {
      ScriptFX.UI.AnimationManager.$2 = window.setTimeout(
        Delegate.create(null, ScriptFX.UI.AnimationManager.$3),
...
ScriptFX.UI.Behavior.getBehaviors = function(domElement, type) {
  ...
  return $0.filter(
    Delegate.create(null, function($p1_0) {
...
ScriptFX.UI.DragDropManager.startDragDrop = function(data, dragVisual, dragOffset, source, context) {
  ...
  ScriptFX.UI.DragDropManager.$0.dragDrop(
    new ScriptFX.UI._Core$0(source),
    context,
    $0,
    dragVisual,
    dragOffset,
...
ScriptFX.ObservableCollection.createClass(
