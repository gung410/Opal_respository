...
{
    public class BaseWriteOnlyEfCoreRepository<TDbContext, TEntity> :
        BaseWriteEfCoreRepository<TDbContext, TEntity, Guid>, IWriteOnlyRepository<TEntity>
        where TEntity : class, IEntity<Guid>
        where TDbContext : DbContext
    {
        public BaseWriteOnlyEfCoreRepository(IUnitOfWorkManager unitOfWorkManager, IDbContextProvider<TDbContext> dbContextProvider)
            : base(unitOfWorkManager, dbContextProvider)
        {
        }
    }

    public class BaseWriteEfCoreRepository<TDbContext, TEntity, TPrimaryKey> :
        BaseWriteOnlyThunderRepository<TEntity, TPrimaryKey>
        where TEntity : class, IEntity<TPrimaryKey>
        where TDbContext : DbContext
    {
        private readonly IDbContextProvider<TDbContext> _dbContextProvider;

        public BaseWriteEfCoreRepository(IUnitOfWorkManager unitOfWorkManager, IDbContextProvider<TDbContext> dbContextProvider)
