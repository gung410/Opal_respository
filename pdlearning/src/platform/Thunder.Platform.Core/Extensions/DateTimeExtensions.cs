...
namespace Thunder.Platform.Core.Extensions
{
    ...
    public static class DateTimeExtensions
    {
        ...
        public static DateTime EndOfDateInSystemTimeZone(this DateTime date)
        {
            return date.ToDateTimeInSystemTimeZone().ToDayEnd();
        }

        public static DateTime StartOfDateInSystemTimeZone(this DateTime date)
        {
            return date.ToDateTimeInSystemTimeZone().ToDayStart();
        }

        public static DateTime ToDateTimeInSystemTimeZone(this DateTime date)
        {
            return TimeZoneInfo.ConvertTimeFromUtc(date, Clock.TimeZoneInfo);
        }

        public static DateTime ToUtcFromSystemTimeZone(this DateTime date)
        {
            return TimeZoneInfo.ConvertTimeToUtc(date, Clock.TimeZoneInfo);
        }
    }
}
