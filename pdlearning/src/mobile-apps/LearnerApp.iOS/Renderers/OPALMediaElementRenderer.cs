...
[assembly: ExportRenderer(typeof(MediaElement), typeof(OPALMediaElementRenderer))]
namespace LearnerApp.iOS.Renderers
{
	public sealed class OPALMediaElementRenderer : ViewRenderer<MediaElement, UIView>
	{
		...
		public OPALMediaElementRenderer()
		{
