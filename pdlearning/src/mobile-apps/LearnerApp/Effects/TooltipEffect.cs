...
namespace LearnerApp.Effects
{
    public static class TooltipEffect
    {
        ...
        public static BindableObject GetCurrentTooltip(Layout view)
        {
            foreach (var child in view.Children)
            {
                if (GetHasTooltip(child))
                {
                    return child;
                }
                ...
                {
                    var tooltip = GetCurrentTooltip(layout);
                    if (tooltip != null)
                    {
                        return tooltip;
                    }
        ...
        public static void OnHasTooltipChanged(BindableObject bindable, object oldValue, object newValue)
        {
    ...
    {
        public ControlTooltipEffect() : base("LearnerApp.TooltipEffect")
        {
        }
    }
}
