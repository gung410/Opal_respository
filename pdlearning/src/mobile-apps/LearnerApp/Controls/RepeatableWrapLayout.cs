...
namespace LearnerApp.Controls
{
    ...
    public class RepeatableWrapLayout : WrapLayout
    {
        ...
        public static BindableProperty ItemTemplateProperty =
            BindableProperty.Create(
                ...
                propertyChanged: (bindable, oldValue, newValue) =>
                {
                    ...
                    if (newValue != null && control.ItemsSource != null && !control._doneItemSourceChanged)
                    {
        ...
        private bool _doneItemSourceChanged = false;
        ...
        private static void ItemsChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            {
                control._doneItemSourceChanged = false;
                return;
            }

            control._doneItemSourceChanged = true;
