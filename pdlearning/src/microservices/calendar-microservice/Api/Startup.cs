...
namespace Microservice.Calendar
{
    public class Startup
    {
        ...
        public string ApiName { get; } = "OPAL2.0 - Calendar API";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services
                ...
                .AddOptions<NotificationTimeZoneOption>().Bind(_configuration.GetSection(nameof(NotificationTimeZoneOption)));
        ...
        {
            dbContextResolver.InitDatabase<CalendarDbContext>(
