...
namespace Microservice.Webinar
{
    public class Startup
    {
        ...
        public string ApiName { get; } = "OPAL2.0 - Webinar API";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                .AddOptions<BigBlueButtonServerOptions>().Bind(_configuration.GetSection(nameof(BigBlueButtonServerOptions)));
        }
        ...
        {
            dbContextResolver.InitDatabase<WebinarDbContext>(
