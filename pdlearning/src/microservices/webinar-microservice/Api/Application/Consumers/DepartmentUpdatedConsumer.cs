...
{
    [OpalConsumer("cx-organization-api.crud.updated.organizationalunit")]
    public class DepartmentUpdatedConsumer : ScopedOpalMessageConsumer<DepartmentChangeMessage>
    {
