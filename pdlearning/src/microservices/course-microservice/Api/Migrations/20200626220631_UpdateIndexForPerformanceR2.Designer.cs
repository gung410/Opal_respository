...
namespace Microservice.Course.Migrations
{
    ...
    [Migration("20200626220631_UpdateIndexForPerformanceR2")]
    partial class UpdateIndexForPerformanceR2
    {
            ...
            modelBuilder.Entity("Microservice.Course.Domain.Entities.CourseEntity", b =>
                {
                    ...
                    b.HasIndex("AlternativeApprovingOfficerId", "IsDeleted");

                    b.HasIndex("ChangedDate", "IsDeleted");

                    b.HasIndex("ContentStatus", "IsDeleted");

                    b.HasIndex("CourseCode", "IsDeleted");

                    b.HasIndex("CreatedBy", "IsDeleted");

                    b.HasIndex("CreatedDate", "IsDeleted");

                    b.HasIndex("CreatedDate", "Status");

                    b.HasIndex("DepartmentId", "IsDeleted");

                    b.HasIndex("ECertificateTemplateId", "IsDeleted");

                    b.HasIndex("ExternalCode", "IsDeleted");

                    b.HasIndex("FirstAdministratorId", "IsDeleted");

                    b.HasIndex("MOEOfficerId", "IsDeleted");

                    b.HasIndex("PDAreaThemeId", "IsDeleted");

                    b.HasIndex("PrimaryApprovingOfficerId", "IsDeleted");

                    b.HasIndex("SecondAdministratorId", "IsDeleted");

                    b.HasIndex("Status", "IsDeleted");

                    b.HasIndex("CreatedDate", "Status", "IsDeleted");
