...
namespace Microservice.Course.Migrations
{
    ...
    [Migration("20201005071249_AddLectureDigitalContentConfigEntity")]
    partial class AddLectureDigitalContentConfigEntity
    {
            ...
            modelBuilder.Entity("Microservice.Course.Domain.Entities.CourseEntity", b =>
                {
                    ...
                    b.HasIndex("AlternativeApprovingOfficerId", "IsDeleted", "CreatedDate");

                    b.HasIndex("ContentStatus", "IsDeleted", "CreatedDate");

                    b.HasIndex("CourseCode", "IsDeleted", "CreatedDate");

                    b.HasIndex("CreatedBy", "IsDeleted", "CreatedDate");

                    b.HasIndex("DepartmentId", "IsDeleted", "CreatedDate");

                    b.HasIndex("ECertificateTemplateId", "IsDeleted", "CreatedDate");

                    b.HasIndex("ExternalCode", "Id", "IsDeleted");

                    b.HasIndex("ExternalCode", "IsDeleted", "CreatedDate");

                    b.HasIndex("FirstAdministratorId", "IsDeleted", "CreatedDate");

                    b.HasIndex("MOEOfficerId", "IsDeleted", "CreatedDate");

                    b.HasIndex("PDAreaThemeId", "IsDeleted", "CreatedDate");

                    b.HasIndex("PrimaryApprovingOfficerId", "IsDeleted", "CreatedDate");

                    b.HasIndex("SecondAdministratorId", "IsDeleted", "CreatedDate");
