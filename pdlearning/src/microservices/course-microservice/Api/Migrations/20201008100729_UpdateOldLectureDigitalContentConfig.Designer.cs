...
namespace Microservice.Course.Migrations
{
    ...
    [Migration("20201008100729_UpdateOldLecture")]
    partial class UpdateOldLectureDigitalContentConfig
    {
            ...
            modelBuilder.Entity("Microservice.Course.Domain.Entities.CourseEntity", b =>
                {
                    ...
                    b.HasIndex("IsDeleted", "AlternativeApprovingOfficerId", "CreatedDate");

                    b.HasIndex("IsDeleted", "ContentStatus", "CreatedDate");

                    b.HasIndex("IsDeleted", "CourseCode", "CreatedDate");

                    b.HasIndex("IsDeleted", "CreatedBy", "CreatedDate");

                    b.HasIndex("IsDeleted", "DepartmentId", "CreatedDate");

                    b.HasIndex("IsDeleted", "ECertificateTemplateId", "CreatedDate");

                    b.HasIndex("IsDeleted", "ExternalCode", "CreatedDate");

                    b.HasIndex("IsDeleted", "ExternalCode", "Id");

                    b.HasIndex("IsDeleted", "FirstAdministratorId", "CreatedDate");

                    b.HasIndex("IsDeleted", "MOEOfficerId", "CreatedDate");

                    b.HasIndex("IsDeleted", "PDAreaThemeId", "CreatedDate");

                    b.HasIndex("IsDeleted", "PrimaryApprovingOfficerId", "CreatedDate");

                    b.HasIndex("IsDeleted", "SecondAdministratorId", "CreatedDate");

                    b.HasIndex("IsDeleted", "Status", "CreatedDate");
