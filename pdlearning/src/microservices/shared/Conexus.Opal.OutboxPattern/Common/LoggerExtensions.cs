...
namespace Conexus.Opal.OutboxPattern
{
    ...
    internal static class LoggerExtensions
    {
        ...
        private static readonly Action<ILogger, Exception> _exceptionWhenSendMessageFromQueue =
            LoggerMessage.Define(LogLevel.Warning, new EventId(5, "ExceptionWhenSendMessageFromQueue"), "There is an exception when send messages from queue.");
        ...
        internal static void ExceptionWhenSendMessageFromQueue(this ILogger logger, Exception exception)
        {
            _exceptionWhenSendMessageFromQueue(logger, exception);
        }
    }
}
