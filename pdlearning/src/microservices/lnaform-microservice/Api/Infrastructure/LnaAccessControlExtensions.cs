...
namespace Microservice.LnaForm.Infrastructure
{
    public static class RepositoryHasDepartmentExtensions
    {
        ...
        // but extend to support more admin roles (DivisionalTrainingCoordinator, SchoolStaffDeveloper) only available for LNA.
        ...
        // LNA module available for more admin roles.
