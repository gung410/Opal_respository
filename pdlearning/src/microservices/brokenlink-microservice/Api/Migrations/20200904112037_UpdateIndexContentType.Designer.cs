...
namespace Microservice.BrokenLink.Migrations
{
    ...
    [Migration("20200904112037_UpdateIndexContentType")]
    partial class UpdateIndexContentType
    {
            ...
            modelBuilder.Entity("Microservice.BrokenLink.Domain.Entities.BrokenLinkReport", b =>
                {
                    ...
                    b.HasIndex("OriginalObjectId", "Module", "CreatedDate")
                        .HasAnnotation("SqlServer:Include", new[] { "Id", "ObjectId", "Url", "Description", "ReportBy", "ReporterName", "ContentType", "ObjectTitle", "ObjectOwnerId", "ObjectOwnerName", "ObjectDetailUrl", "ParentId" });

                    b.HasIndex("ReportBy", "ContentType", "Module", "CreatedDate")
                        .HasAnnotation("SqlServer:Include", new[] { "Id", "OriginalObjectId", "ObjectId", "Url", "ReporterName", "Description", "ObjectTitle", "ObjectOwnerId", "ObjectOwnerName", "ObjectDetailUrl", "ParentId" });
