...
namespace Microservice.BrokenLink.Migrations
{
    ...
    [Migration("20200904105954_AddColumnContentTypeAndReporterName")]
    partial class AddColumnContentTypeAndReporterName
    {
            ...
            modelBuilder.Entity("Microservice.BrokenLink.Domain.Entities.BrokenLinkReport", b =>
                {
                    ...
                    b.HasIndex("OriginalObjectId", "Module", "CreatedDate")
                        .HasAnnotation("SqlServer:Include", new[] { "Id", "ObjectId", "Url", "Description", "ReportBy", "ObjectTitle", "ObjectOwnerId", "ObjectOwnerName", "ObjectDetailUrl", "ParentId" });

                    b.HasIndex("ReportBy", "Module", "CreatedDate")
                        .HasAnnotation("SqlServer:Include", new[] { "Id", "OriginalObjectId", "ObjectId", "Url", "Description", "ObjectTitle", "ObjectOwnerId", "ObjectOwnerName", "ObjectDetailUrl", "ParentId" });
