import {
  ...
  ChangeDetectionStrategy, TemplateRef, ChangeDetectorRef, ElementRef
} from '@angular/core';
import { BaseComponent } from '../../abstracts/base.component';
import { MediaObserver } from '@angular/flex-layout';

@Component({
  selector: 'cx-tag-group-simple',
  templateUrl: './cx-tag-group-simple.component.html',
  styleUrls: ['./cx-tag-group-simple.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CxTagGroupSimpleComponent<RowData> extends BaseComponent {
  @Input() tagGroup: any;
  @Input() tagProperty: string;
  @Input() tagGroupField: string;
  @Input() tagGroupFieldDisplay: string;
