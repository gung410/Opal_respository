    ...
    public class JsonExceptionMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            else
            {
                httpErrorDetail = new HttpErrorDetails()
                {
                    StatusCode = (ex is cxHttpResponseException) ? (ex as cxHttpResponseException).StatusCode : (HttpStatusCode)context.Response.StatusCode,
                    Message = ex.Message,
                    ErrorSource = ex.Source
                };
            }

            if (_hostingEnvironment.IsDevelopment() || _hostingEnvironment.IsEnvironment("development"))
            {
