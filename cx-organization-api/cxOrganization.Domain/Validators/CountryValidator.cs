...
{
    public class CountryValidator : DepartmentValidator
    {
        public CountryValidator(IDepartmentRepository departmentRepository,
        ...
        {
            var countryDto = (CountryDto)dto;
            if (countryDto != null && countryDto.Identity.Archetype != ArchetypeEnum.Country)
            {
            ...
            if (departmentEntity != null && departmentEntity.ArchetypeId != (short)ArchetypeEnum.Country)
            {
