...
namespace cxOrganization.Domain.Mappings
{
    public class CandidateDepartmentMappingService : DepartmentMappingService
    {
        ...
        {
            if (department == null || department.ArchetypeId != (short)ArchetypeEnum.CandidateDepartment)
            {
                return null;
            }

            var departmentDto = new CandidateDepartmentDto
            {
        ...
        {
            var departmentDto = (CandidateDepartmentDto)department;
            //Initial  entity
        ...
        private DepartmentEntity NewDepartmentEntity(HierarchyDepartmentEntity parentHd, CandidateDepartmentDto departmentDto)
        {
            var entity = new DepartmentEntity
            {
                ...
                ArchetypeId = (int)ArchetypeEnum.CandidateDepartment,
            ...
            foreach (var departmentTypeId in DepartmentTypeIds)
            {
                ...
                entity.DT_Ds.Add(new DTDEntity()
                {
