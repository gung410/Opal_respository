...
namespace cxOrganization.WebServiceAPI.Controllers
{
    ...
    public class BroadcastMessageController : ApiControllerBase
    {
        ...
        public BroadcastMessageController(IBroadcastMessageService broadcastMessageService, IAdvancedWorkContext workContext)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [PermissionRequired(OrganizationPermissionKeys.CRUDinBroadcastMessages)]
