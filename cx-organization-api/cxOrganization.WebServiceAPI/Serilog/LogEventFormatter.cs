...
namespace Data.Intergration.Api.Serilog
{
    public class LogEventFormatter : ITextFormatter
    {
        public void Format(LogEvent logEvent, TextWriter output)
        {
            ...
            eventLogMessage.Payload.Identity.ClientId = "organization.domain.api";
            ...
            if (logEvent.Exception != null)
            {
                ...
                if (logEvent.Exception.InnerException != null)
                {
                    ...
                    eventLogMessage.Payload.Body.InnerException.Message = logEvent.Exception.InnerException.Message;
